    ...
    <div class="centerbody">
      ...
      <el-dialog title="新建数据" :visible.sync="dialogaddFormVisible">
        <el-form :model="addform" :rules="rules" ref="addform">
          <el-form-item label="编号" :label-width="formLabelWidth" prop="rating_id">
            <el-input v-model="addform.rating_id" autocomplete="off"></el-input>
          </el-form-item>
          ...
          <el-form-item label="评级日期" :label-width="formLabelWidth" prop="rating_date">
            <el-date-picker v-model="addform.rating_date" type="date" placeholder="选择日期" style="width: 100% ;">
            </el-date-picker>
          </el-form-item>
          <el-form-item label="评级系数" :label-width="formLabelWidth" prop="rating_code">
            <el-select v-model="addform.rating_code" placeholder="请选择" style="width: 100% ;">
          ...
          <el-form-item label="评估指标" :label-width="formLabelWidth" prop="evaluation_number">
            <el-input v-model="addform.evaluation_number" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="拥挤程度" :label-width="formLabelWidth" prop="is_crowded">
            <el-select v-model="addform.is_crowded" placeholder="请选择是否拥挤" style="width: 100% ;">
      ...
      <el-dialog title="修改数据" :visible.sync="dialogeditFormVisible" :before-close="handleClose">
        <el-form :model="editform" :rules="rules" ref="editform">
          ...
          <el-form-item label="司机编号" :label-width="formLabelWidth" prop="driver_id">
            <el-input v-model="editform.driver_id" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="线路编号" :label-width="formLabelWidth" prop="route_id">
            <el-input v-model="editform.route_id" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="线路轮次" :label-width="formLabelWidth" prop="round_number">
            <el-input v-model="editform.round_number" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="评级日期" :label-width="formLabelWidth" prop="rating_date">
            <el-date-picker v-model="editform.rating_date" type="date" placeholder="选择日期" style="width: 100% ;">
            </el-date-picker>
          </el-form-item>
          <el-form-item label="评级系数" :label-width="formLabelWidth" prop="rating_code">
            <el-select v-model="editform.rating_code" placeholder="请选择" style="width: 100% ;">
              <el-option label="A" value="A"></el-option>
              <el-option label="B" value="B"></el-option>
              <el-option label="C" value="C"></el-option>
            </el-select>
          ...
          <el-form-item label="评估指标" :label-width="formLabelWidth" prop="evaluation_number">
            <el-input v-model="editform.evaluation_number" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="拥挤程度" :label-width="formLabelWidth" prop="is_crowded">
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          <el-form-item class="flex-item" style="flex: 2;">
            <el-select v-model="formInline.searchColumn" placeholder="请选择查询列">
              ...
              <el-option label="司机姓名" value="driver_name"></el-option>
  ...
  methods: {
    ...
    addData() {
      ...
      this.$refs.addform.validate((valid, errors) => {
        if (valid) {
          axios.post('http://106.75.217.80:3334/bus-sys/adddriverrating', this.addform)
            .then((response) => {
    ...
    handleDelete(row) {
      this.$confirm('确定要删除吗?', '提示', {
        ...
        axios.post('http://106.75.217.80:3334/bus-sys/deletedriverrating', row)
          .then((response) => {
    ...
    fetchDrivers() {
      this.loading = true;
      axios.get('http://106.75.217.80:3334/bus-sys/getdriverrating') // 假设后端接口路径为 /api/drivers
        .then(response => {
